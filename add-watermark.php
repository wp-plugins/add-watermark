...
<div class="add-watermark-preview"
	...
	<div class="watermark-pos">
		<div class="watermark-pos2">
			<div class="watermark" style="outline: 1px dotted red;"></div>
		</div>
	</div>
</div>
<?php
...
<?php
	...
	function outputImageSelect() {
		...
		$url = $setting ? wp_get_attachment_url($setting) : plugin_dir_url( __FILE__ ) . 'images/watermark.png';
?>
<div class="add-watermark-image">
	...
	<input class="add-watermark-image-url" type="hidden"
		...
		value="<?php echo esc_attr($url) ?>" /> <img
